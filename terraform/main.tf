# terraform/main.tf
# Production-Ready GitOps Platform Infrastructure
...
resource "aws_lb_listener_rule" "green" {
  ...
  # Condition that will never match initially (for green to be dormant)
  condition {
    host_header {
      values = ["green.${var.project_name}.internal"]
    }
  }
